...
public class Dialog_noInternet_En extends Dialog implements android.view.View.OnClickListener{
	...
	public Dialog_noInternet_En(Context context) {
		super(context);
...
protected void onCreate(Bundle savedInstanceState) {
	...
	private void init() {
		setContentView(R.layout.dialog_nointernet_en);
